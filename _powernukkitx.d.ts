...
declare module ":powernukkitx" {
    ...
    type cmdBuilder = {
        ...
        setCallback: (callback: (sender: Object, args: string[]) => void) => cmdBuilder,
        createCommandPattern: (pattern: string) => cmdBuilder,
        createDefaultPattern: () => cmdBuilder,
        addCustomTypeParameter: (name: string, optional: boolean, commandParamType: Object, paramNode: Object, options: Object) => cmdBuilder,
